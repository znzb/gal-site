...
<template>
  ...
  >
    <div class="relative aspect-[3/4] overflow-hidden bg-gray-200">
      ...
      <div class="absolute top-2 right-2 bg-primary text-white text-xs px-2 py-1 rounded-full shadow-md">
        {{ game.size }}
      </div>
    ...
    <div class="p-3">
      ...
      <div class="flex items-center justify-between">
        ...
        <button class="flex items-center bg-primary text-white text-xs px-3 py-1.5 rounded-full hover:bg-primary/90 transition-all duration-300 transform hover:scale-105 active:scale-95">
