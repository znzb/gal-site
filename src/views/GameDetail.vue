...
import { ArrowLeft, Download, Star, Share2, Heart, Clock, HardDrive, Calendar, MessageSquare, Link2, User, ChevronDown, ChevronUp, Home, BookOpen } from 'lucide-vue-next'
...
<template>
  ...
  <div v-else-if="game" :key="gameId" class="min-h-screen bg-gradient-to-br from-pink-50/50 to-white">
